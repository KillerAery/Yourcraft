...
public:
	struct ObjPart
	{
		...
		std::vector<DirectX::VertexPositionNormalTexture> vertices;	// 顶点集合
...
private:
	void AddVertex(const DirectX::VertexPositionNormalTexture& vertex, DWORD vpi, DWORD vti, DWORD vni);
